...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AlexeiLibraryAccessors laccForAlexeiLibraryAccessors = new AlexeiLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>amplituda</b> with <b>com.github.lincollincol:Amplituda</b> coordinates and
     * with version reference <b>amplituda</b>
     * <p>
    ...
    /**
     * Dependency provider for <b>waveformseekbar</b> with <b>com.github.massoudss:waveformSeekBar</b> coordinates and
     * with version reference <b>waveformseekbar</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getWaveformseekbar() {
        return create("waveformseekbar");
    }

    /**
     * Group of libraries at <b>alexei</b>
     */
    public AlexeiLibraryAccessors getAlexei() {
        return laccForAlexeiLibraryAccessors;
    }
    ...
    public static class AlexeiLibraryAccessors extends SubDependencyFactory {
        private final AlexeiFroloLibraryAccessors laccForAlexeiFroloLibraryAccessors = new AlexeiFroloLibraryAccessors(owner);

        public AlexeiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>alexei.frolo</b>
         */
        public AlexeiFroloLibraryAccessors getFrolo() {
            return laccForAlexeiFroloLibraryAccessors;
        }

    }

    public static class AlexeiFroloLibraryAccessors extends SubDependencyFactory {

        public AlexeiFroloLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>waveformseekbar</b> with <b>com.github.alexei-frolo:WaveformSeekBar</b> coordinates and
         * with version reference <b>waveformseekbarVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getWaveformseekbar() {
            return create("alexei.frolo.waveformseekbar");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>amplituda</b> with value <b>1.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>waveformseekbar</b> with value <b>5.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>waveformseekbarVersion</b> with value <b>1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWaveformseekbarVersion() { return getVersion("waveformseekbarVersion"); }
